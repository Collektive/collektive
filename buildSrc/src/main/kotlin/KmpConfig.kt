...
fun KotlinDependencyHandler.collektive(project: String): ProjectDependency = project(":collektive-$project")

fun DependencyHandler.collektive(project: String) = project(":collektive-$project")
