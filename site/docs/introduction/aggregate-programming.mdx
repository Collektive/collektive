...
In this context, **aggregate programming**[<sup>1</sup>](#bibliography) emerges as a **relevant macroprogramming approach**. It is based on the **functional composition** of **reusable collective behavior blocks**, with the goal of efficiently achieving **complex** and **resilient behaviors** in **dynamic networks**.

### Key Properties of Aggregate Programming

- **Self-organizing**: the system as a whole is capable of achieving globally coordinated behaviors through decentralized interactions among individual components.
