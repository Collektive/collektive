...
##  Collektive & Alchemist Simulator
### How to run
...
To run the examples, you need to clone the repository on your pc, moving into the root folder and running the following command:
