...
The library function [neighboring](../explanation/dsl-descriptions.mdx?search=neighboring) is a **aggregate operator** and is used to observe the value of an expression [local] across neighboring nodes.
